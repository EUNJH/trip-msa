  ...
  $.ajax({
    ...
    success: function (response) {
      for (let i = 0; i < response.length; i++) {
        ...
        $.ajax({
          type: "GET",
          url: `http://localhost:5081/user/${response[i]["username"]}`,
          contentType: "application/json; charset=utf-8",
          success: function (response) {
            let userReviewProfile_img = response["profileImgUrl"];
            let userReviewNickname = response["nickname"];
                                            ...
                                            <div class="card__overlay">
                                                <div class="card__header">
                                                    ...
                                                    <div class="card__thumb2">
                                                        <img src="${userReviewProfile_img}" id="${i}p" alt="프로필 사진"/>
                                                    </div>
